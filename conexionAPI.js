...
async function enviarProducto(nombre, precio, imagen){
    //const conexion = await fetch("https://alura-api-eight.vercel.app/productos",{
    return await fetch("https://alura-api-eight.vercel.app/productos",{
        method: "POST",
...
async function buscarProducto(id){
    ...
    return await fetch(`https://alura-api-eight.vercel.app/productos?id=${id}`);
...
async function borrarProducto(id){
    ...
    return await fetch(`https://alura-api-eight.vercel.app/productos/${id}`,{
        method: "DELETE"   
    })
    //const conexionConvertida = conexion.json();
